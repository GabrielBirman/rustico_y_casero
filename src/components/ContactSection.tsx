...
const ContactSection = () => {
  return (
    <section id="contacto" className="py-20 md:py-28 bg-accent/50">
      <div className="container max-w-3xl text-center">
        <p className="font-body text-sm tracking-[0.2em] uppercase text-primary mb-3">Contacto</p>
        ...
        <a
          href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hola! Quiero hacer un pedido de prepizzas 🍕")}`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 px-8 py-4 bg-secondary text-secondary-foreground font-body font-bold rounded-lg hover:opacity-90 transition-opacity text-sm uppercase tracking-wider"
        >
